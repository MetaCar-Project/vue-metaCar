    ...
    <main class="form-signin w-100 m-auto">
      <div class="row">
        ...
        <form action="/signup" method="post" name="member">
          ...
          <input type="text" name="name" value="" class="form-control" placeholder="이름" />
          ...
          <br>
          <button class="btn btn-md btn-primary btn-block signup-btn" type="button" id="checkbutton">확인</button>
          ...
          <br>
          <br>
          <input type="password" name="password" value="" class="form-control" placeholder="비밀번호" data-pw="cant" />
          ...
          <br>
          <input type="password" name="confirm_password" value="" class="form-control" placeholder="비밀번호 확인"
            onkeyup="passConfirm()" />
          ...
          <br>
          <input type="text" id="name" name="phone" value="" class="form-control" placeholder="전화번호(xxx-xxxx-xxxx)" />
          ...
          <input type="text" id="regnum" name="regNum" value="" class="form-control" placeholder="주민등록번호" />
          ...
          <button id="add" class="btn btn-lg btn-primary btn-block signup-btn" type="submit">계정 생성</button>
        </form>
      </div>
